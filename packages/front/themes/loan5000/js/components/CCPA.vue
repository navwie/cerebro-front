<template>
    <section class="GSC_ccpa d-none d-sm-block" id="page-title" :style="mainColor">
        <div class="row d-flex justify-content-around w-100">
            <div style="width: calc(100% - 250px);">
                <h1>CALIFORNIA “DON’T SELL MY INFO” PRIVACY NOTICE</h1>
            </div>
            <div style="width:250px">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active text-gray" aria-current="page">CCPA Privacy Notice</li>
                </ol>
            </div>
        </div>
    </section>
    <section id="content" :style="mainColor">
                ...
                <div class="row col-mb-50">
                    ...
                    <div class="col-12"><p>
                        ...
                        <p class="mb-4">This privacy notice is supplemental to the information contained
                            in {{ app_name }}’s (“site,” “we,” “us,” or “our”) <a
                                href="privacy">Privacy
                                Policy</a> and applies solely to Residents of California (“Consumers” or “you”) who
                            access and
                        ...
                        <p class="mb-4">California consumers have the right to request that we inform them on what
                            ...
                            forth in
                            our <a href="privacy">Privacy Policy</a>, we collect several types of information about
                            consumers,
