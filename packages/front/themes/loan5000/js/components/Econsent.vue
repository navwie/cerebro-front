<template>
    <section class="GSC_econsent d-none d-sm-block" id="page-title" :style="mainColor">
        <div class="row d-flex justify-content-around w-100">
            <div style="width: calc(100% - 250px);">
                <h1>CONSENT TO RECEIVE ELECTRONIC COMMUNICATIONS</h1>
            </div>
            <div style="width:250px">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active text-gray" aria-current="page">E-Consent</li>
                </ol>
            </div>
        </div>
    </section>
