<template>
    <div :style="mainColors" class="GSC_main container"> 
        <section class="page-section">
            <div class="row">
                <div class="col">
                    <GreenLabel :title="'CALIFORNIA “DON’T SELL MY INFO” PRIVACY NOTICE'" :color="'var(--main-color)'" :extraClass="'roboto'"/>
                </div>
            </div>
            <div class="row p-8">
                <div class="col" :style="mainColor"> 
                    <h3>FOR CALIFORNIA RESIDENTS ONLY</h3>
                    <p>IF YOU ARE NOT A RESIDENT OF CALIFORNIA, THIS POLICY DOES NOT APPLY TO YOU AND PLEASE
                        DO NOT CONTINUE.</p>

                    <p>This privacy notice is supplemental to the information contained
                    ...
                    <p>Only California residents, or their authorized registered designated agents, can submit
                        a CCPA request pertaining to their Personal Information for verification and processing.</p>

                    <h3>REQUEST TO KNOW HOW PERSONAL INFORMATION IS COLLECTED, DISCLOSED, OR SOLD.</h3>
                    <p>California consumers have the right to request that we inform them on what Personal
                    ...
                    <h3>REQUEST FOR DELETION OF PERSONAL INFORMATION.</h3>
                    <p>You have a statutory right under CCPA to request the deletion of your Personal
                    ...
                    <h3>OPT-OUT OF THE SALE OF PERSONAL INFORMATION.</h3>
                    <p>Consumers have the right to opt-out of any sale of their personal information by a
                    ...
                    <p>Consumers have a right not to receive discriminatory treatment by this site for the
                    ...
                    <h3>LIMITATIONS.</h3>
                    <p>Consumers may only submit a CCPA request to be verified by this site twice within a
                    ...
                    <h3>RESPONSE TIME.</h3>
                    <p>This site reasonably endeavors to respond and process verified consumer request within
                    ...
                    <h3>MODIFICATIONS.</h3>
                    <p>This site reserves the right to modify, replace, and amend this privacy notice at any
